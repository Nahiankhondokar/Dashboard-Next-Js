        ...
        <main className="relative min-h-screen bg-black text-zinc-300 pb-24">
            ...
            <nav className="sticky top-0 z-40 bg-black/80 backdrop-blur-md border-b border-zinc-900 px-6 py-4 mb-12">
                <div className="max-w-5xl mx-auto flex justify-between items-center">
                    <Link
                        href="/#blog"
                        className="group flex items-center gap-2 text-zinc-500 hover:text-indigo-400 transition-colors font-bold uppercase text-[10px] tracking-[2px]"
                    >
            ...
            <article className="max-w-4xl mx-auto px-6">
                ...
                <header className="mb-16">
                    ...
                    {blog.subtitle && (
                        <motion.p
                            ...
                            className="text-xl md:text-2xl text-zinc-400 font-medium leading-relaxed max-w-2xl italic border-l-2 border-indigo-500 pl-8 py-2"
                        >
                            {blog.subtitle}
                        </motion.p>
                    )}
                ...
                <div className="prose prose-invert lg:prose-xl max-w-none 
                    ...
                    prose-code:text-indigo-200 prose-code:bg-zinc-900 prose-code:px-1.5 prose-code:py-0.5 prose-code:rounded-md prose-code:before:content-none prose-code:after:content-none
                    prose-pre:bg-zinc-950 prose-pre:border prose-pre:border-zinc-800 prose-pre:rounded-3xl
                    prose-blockquote:border-l-indigo-500 prose-blockquote:bg-zinc-900/30 prose-blockquote:py-2 prose-blockquote:rounded-r-2xl
                ...
                <footer className="mt-32 pt-16 border-t border-zinc-900">
                    <div className="flex flex-col md:flex-row items-center justify-between gap-8">
                        <div className="flex items-center gap-4">
                            <div className="w-16 h-16 rounded-2xl bg-indigo-500 flex items-center justify-center font-black text-white text-2xl">
                                {blog.title.charAt(0)}
                            </div>
                            <div>
                        ...
                        <Link
                            href="/#contact"
                            className="bg-white text-black px-8 py-4 rounded-2xl font-black uppercase text-xs tracking-widest hover:bg-indigo-500 hover:text-white transition-all active:scale-95"
                        >
